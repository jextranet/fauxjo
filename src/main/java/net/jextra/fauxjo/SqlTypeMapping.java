...
/**
 * Mapping between all SQL types and a Java type. It is intended to be used one-directional from a known SQL type to a single Java type.
 */
public class SqlTypeMapping extends HashMap<Integer, Class<?>>
{
    ...
    {
        return getInstance().get( sqlType );
    }
}
